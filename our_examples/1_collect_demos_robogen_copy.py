...
def main(args):
    ...
    if args.target_obj is None:
        ...
        # obj_info = next((obj for obj in scene_info["objects"] if obj["name"] == args.target_parent_obj), None)
    else:
        obj_info = scene_info["objects"][args.target_obj]
        # obj_info = next((obj for obj in scene_info["objects"] if obj["name"] == args.target_obj), None)

    cousin_category_names, cousin_model_names, cousin_link_names = [obj_info["type"]], [obj_info["usd_path"]], [args.target_link]
    # print(obj_info)
    # print(cousin_type, cousin_usd_path, cousin_link_names)
    # exit()
    ...
    # }
    cfg["wrapper"] = {
        "type": "OpenCabinetPickBowlRobogenWrapper",
        "eef_z_offset": robot_params["eef_z_offset"],
        "cab_categories": cousin_category_names,
        "cab_models": cousin_model_names,
        "cab_links": cousin_link_names,
