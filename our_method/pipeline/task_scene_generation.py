...
from deps.OmniGibson.omnigibson import scene_graphs
...
class TaskSceneGenerator:
    ...
    def __call__(
        ...
        scene_graphs_path = scene_info["scene_graph"]
        ...
        # Bowl Task Camera setting
        # og.sim.viewer_camera.set_position_orientation(th.tensor([0.55625, -1.90427,  1.55959], dtype=th.float), th.tensor([0.52677, -0.00024, -0.00377, 0.85], dtype=th.float))
        # Office Default
        ...
        # og.sim.viewer_camera.set_position_orientation(th.tensor([2.75254, -0.2175,  2.39017], dtype=th.float), th.tensor([0.39174, 0.31138, 0.53022, 0.68443], dtype=th.float))
        # og.sim.viewer_camera.set_position_orientation(th.tensor([-0.12073, 3.03728,  1.29486], dtype=th.float), th.tensor([-0.03126, 0.62574, 0.77881, -0.03027], dtype=th.float))
        ...
        # Toilet Task Camera setting
        # og.sim.viewer_camera.set_position_orientation(th.tensor([1.08377, -3.50662,  2.98795], dtype=th.float), th.tensor([0.5299, 0.02283, 0.03254, 0.84713], dtype=th.float))
        # Toilet Soup
        # og.sim.viewer_camera.set_position_orientation(th.tensor([1.07439, -1.74873,  2.56799], dtype=th.float), th.tensor([0.40551, 0.04312, 0.09143, 0.90849], dtype=th.float)) # Pick up box
        
        
        # Long Sofa Camera Setting
        # og.sim.viewer_camera.set_position_orientation(th.tensor([-0.92913, -2.77029,  2.83428], dtype=th.float), th.tensor([0.46769, -0.0289, -0.06067, 0.84713], dtype=th.float))
        # og.sim.viewer_camera.set_position_orientation(th.tensor([-1.37023, -2.70932,  2.11991], dtype=th.float), th.tensor([0.54478, -0.07405, -0.07405, 0.82697], dtype=th.float)) # Box on the sofa
        # og.sim.viewer_camera.set_position_orientation(th.tensor([5.69812, -0.14696,  2.56452], dtype=th.float), th.tensor([0.49119, 0.20838, 0.36631, 0.76231], dtype=th.float)) # tomato can
        # og.sim.viewer_camera.set_position_orientation(th.tensor([0.60934, -0.94408,  1.31221], dtype=th.float), th.tensor([0.55621, 0.23719, 0.31561, 0.73127], dtype=th.float)) # next to box
        # og.sim.viewer_camera.set_position_orientation(th.tensor([1.73872, -3.84219,  2.93949], dtype=th.float), th.tensor([0.55894, 0.07675, 0.07199, 0.8225], dtype=th.float)) # far away
        # og.sim.viewer_camera.set_position_orientation(th.tensor([2.90039, -0.90433,  1.98946], dtype=th.float), th.tensor([0.47086, 0.32484, 0.45796, 0.68047], dtype=th.float)) # far away
        # og.sim.viewer_camera.set_position_orientation(th.tensor([3.83, -0.20679,  2.74203], dtype=th.float), th.tensor([0.45089, 0.03005, 0.04739, 0.89081], dtype=th.float)) # far away
        
        # Table
        # og.sim.viewer_camera.set_position_orientation(th.tensor([1.77514, -1.69606,  1.81195], dtype=th.float), th.tensor([0.52664, 0.08841, 0.09753, 0.83984], dtype=th.float)) # Pick up box
        # og.sim.viewer_camera.set_position_orientation(th.tensor([0.56102, -1.59111,  1.59714], dtype=th.float), th.tensor([0.39532, -0.0244, -0.06706, 0.91577], dtype=th.float)) # Pick up box
        
        
        # Small Sofa
        # og.sim.viewer_camera.set_position_orientation(th.tensor([0.72937, -1.91611,  1.40528], dtype=th.float), th.tensor([ 0.63794, -0.05857, -0.08123, 0.76355], dtype=th.float)) # can, bottle
        # og.sim.viewer_camera.set_position_orientation(th.tensor([4.72667, -0.87565,  2.24658], dtype=th.float), th.tensor([ 0.42933, 0.19917, 0.35867, 0.80459], dtype=th.float)) # can, bottle
        # og.sim.viewer_camera.set_position_orientation(th.tensor([-2.41062, -1.62103,  2.65919], dtype=th.float), th.tensor([ 0.49165, -0.22362, -0.3544, 0.76333], dtype=th.float)) # can, bottle
        # og.sim.viewer_camera.set_position_orientation(th.tensor([6.4842, -0.1074,  2.40664], dtype=th.float), th.tensor([ 0.40198, 0.34571, 0.54385, 0.65048], dtype=th.float)) # can, bottle
        
        # Kitchen
        # og.sim.viewer_camera.set_position_orientation(th.tensor([1.36548, -1.74249,  1.07219], dtype=th.float), th.tensor([ 0.66333, 0.0145, 0.01367, 0.74807], dtype=th.float)) # can, bottle
        ...
        # Habitat Bowl Task Camera setting
        # og.sim.viewer_camera.set_position_orientation(th.tensor([0.32938, -2.91661,  2.38593], dtype=th.float), th.tensor([ 0.5227, -0.00762, -0.01404, 0.85237], dtype=th.float))
        # Habitat Apple Task Camera Seting
        # og.sim.viewer_camera.set_position_orientation(th.tensor([0.32938, -2.91661,  2.38593], dtype=th.float), th.tensor([ 0.5227, -0.00762, -0.01404, 0.85237], dtype=th.float))
        # og.sim.viewer_camera.set_position_orientation(th.tensor([1.10365, -5.06405,  4.37386], dtype=th.float), th.tensor([ 0.52106, 0.00038, -0.00288, 0.85351], dtype=th.float)) # bottle, drawer
    ...
    def add_task_object(scene, scene_info, scene_graphs, cam_pose, obj_info_json, save_dir, visual_only=False, probability_map = True, capture_env=False, camera_error=False, 
        ...
        with og.sim.stopped():    
            ...
            for obj_name, obj_info in obj_info_json["objects"].items():
                ...
                if placement == "inside":
                    distractor_objects.append(parent_obj_name)
                sampled_point_3d = None
                probability_map_sampler = None

                if placement == "above" and probability_map:
                    ...
                    if not blended_number_img_path:
                        camera_error = True
                    ...
                    assert front_child_img_path is not None, \
                    f"❌ Image not found: Could not find a model image for either parent '{parent_obj_name}' or child '{child_obj_name}'."
                    ...
                    if not camera_error: 
                        if probability_map:
                            ...
                            # sofa_read
                            # gpt_text_response = "1: 0.00, 2: 0.00, 3: 0.00, 4: 0.20, 5: 0.25, 6: 0.20, 7: 0.10, 8: 0.15, 9: 0.10"
                            # gpt_text_response = "1: 0.00, 2: 0.00, 3: 0.00, 4: 0.15, 5: 0.25, 6: 0.15, 7: 0.15, 8: 0.20, 9: 0.10"
                            # gpt_text_response = "1: 0.15, 2: 0.20, 3: 0.10, 4: 0.15, 5: 0.00, 6: 0.00, 7: 0.15, 8: 0.10, 9: 0.15"
                            ...
                            prob_map_mask = generate_prob_map_from_parent_bbox(all_object_info, child_obj_name, prob_map_save_path="./our_method_test/acdc_output/task_scene_generation/figure.png")
                            ...
                            save_probability_map_image(prob_map, center_points_2d, bounds, 
                                                        save_path="./our_method_test/acdc_output/task_scene_generation/init_prob_map_vis.png")
            ...
            distractor_obj_info_json_list = []
            if use_distractor_noise:
                for i in range(len(distractor_objects)):
                    parent_obj_name = distractor_objects[i]
                    # TODO : Resizing에서 경로 바꾸기
                    distractor_output_path = os.path.join(distractor_output_path, f"{parent_obj_name}", "distractor_object_resizing_output_info_0.json")
                    with open(distractor_output_path, "r") as f:
                        distractor_obj_info_json = json.load(f)
                    distractor_obj_info_json_list.append(distractor_obj_info_json)
                    for obj_name, obj_info in distractor_obj_info_json["objects"].items():
                        obj_name_ = obj_name.replace(" ", "_")
                        # scale fallback 처리
        ...
        for obj_name, obj_info in obj_info_json["objects"].items():
            ...
            # TODO
            og.sim.step()
            if not use_distractor_noise:
                if placement == "above"or placement == "inside":
                # if placement == "above":
                    snap_obj_pos, snap_obj_quat = TaskSceneGenerator.snap_to_place(scene, 
                                                        obj_info,
                                                        cam_pose=cam_pose,
                                                        child_obj_name=obj_name,
                                                        parent_obj_name=obj_info["parent_object"],
                ...
                skipped_distractors = TaskSceneGenerator.place_with_distractor(scene, 
                                                        obj_info,
                                                        cam_pose=cam_pose,
                                                        child_obj_name=obj_name,
                                                        parent_obj_name=obj_info["parent_object"],
                                                        placement=obj_info["placement"],
                                                        distractor_list=distractor_obj_info_json_list
                                                    )
            ...
            for i in range(1):
                if probability_map and obj_info_json["objects"][obj_name]["probability_map"] is not None:
                    # og.sim.viewer_camera.set_position_orientation(th.tensor([-0.3616, -2.9108,  2.2365], dtype=th.float), th.tensor([5.3933e-01, 6.4206e-03, 4.1202e-18, 8.4207e-01], dtype=th.float))
                    # og.sim.viewer_camera.set_position_orientation(th.tensor([1.3395, -2.87351,  2.26339], dtype=th.float), th.tensor([0.50392, -0.00841, -0.00935, 0.86366], dtype=th.float))
            ...
            if placement == "inside":
                ...
                if inside_position_randomization:
                    ...
                    # 2. parent bbox의 x, y 최소/최대 계산
                    x_min = np.min(parent_obj_inside_bbox[:, 0])
                    x_max = np.max(parent_obj_inside_bbox[:, 0])
                    y_min = np.min(parent_obj_inside_bbox[:, 1])
                    y_max = np.max(parent_obj_inside_bbox[:, 1])

                    # 3. 랜덤 위치 샘플링
                    rand_x = np.random.uniform(x_min, x_max)
                    rand_y = np.random.uniform(y_min, y_max)
                    rand_z = child_pos[2]  # z는 그대로 유지
                ...
                if rotation_randomization:
                    ...
                    # 기존 쿼터니언 → 오일러
                    child_rot = R.from_quat(child_quat)
                    roll, pitch, yaw = child_rot.as_euler('xyz', degrees=False)

                    # yaw 오프셋 추가
                    # np.random>.seed(42)
                    random_yaw_offset_deg = np.random.uniform(-random_degree, random_degree)
                    random_yaw_offset_rad = np.radians(random_yaw_offset_deg)

                    new_yaw = yaw + random_yaw_offset_rad
            ...
            if placement == "inside":
                for i in range(4):
                    corner_pos = parent_obj_inside_bbox[i]
                    ...
                    obj_scene_info[f"tf_from_bbox_{i}_cam"] = tf

            # skipped_distractors, distractor_obj_info_json_list
            scene_info["objects"][obj_name] = obj_scene_info
            
            # skipped_distractors, distractor_obj_info_json_list
            if use_distractor_noise:
                for i in range(len(distractor_obj_info_json_list)):
                    distractor_obj_json = distractor_obj_info_json_list[i]["objects"]
                    ...
                    for distractor_obj_name in distractor_obj_list:
                        ...
                        #                                 child_obj_name=obj_name)
                        # 현재 child의 중심 위치
                        distractor_obj_pos, distractor_obj_quat = distractor_obj.get_position_orientation()

                        # 추가된 오브젝트 Scene Info 추가
                        distractor_obj_scene_info = {
                            "category": distractor_obj.category,
                            "model": distractor_obj.model,
                            "scale": distractor_obj.scale,
                            "bbox_extent": distractor_obj.aabb_extent.cpu().detach().numpy(),
                            "tf_from_cam": T.pose2mat(T.relative_pose_transform(        
                                distractor_obj_pos,
                                distractor_obj_quat,
                                cam_pose[0],
                        ...
                        # skipped_distractors, distractor_obj_info_json_list
                        scene_info["objects"][distractor_obj_name] = distractor_obj_scene_info
        # Initialize all objects by taking one step
        # og.sim.step()
        return scene
    
    @staticmethod
    def get_VLM_prompt_image(scene, parent_obj_name, child_obj_name, scene_graphs, parent_re_axis_mat, child_re_axis_mat, output_dir = "./our_method_test/acdc_output/"):
        """
        ...
        if parent_obj_name in all_object_info:
            all_object_info["parent_obj"] = all_object_info.pop(parent_obj_name)
        else:
    ...
    @staticmethod
    def get_inside_bbox(scene, parent_obj_name, child_obj_name, parent_re_axis_mat, child_re_axis_mat, max_bound=0.2):
        """
        위에서 본 parent object의 segmentation mask를 시각화하고 반환합니다.
        ...
        parent_pos = parent_pos.cpu().numpy() if isinstance(parent_pos, th.Tensor) else parent_pos
        parent_quat = parent_quat.cpu().numpy() if isinstance(parent_quat, th.Tensor) else parent_quat 
        parent_rot_mat = R.from_quat(parent_quat).as_matrix()  # shape: (3, 3)
        # 2. world → local 변환행렬
        world_to_local_rot = parent_rot_mat.T  # inverse rotation
        ...
        # parent_bbox = parent_bbox_dict["bbox_top_in_desired_frame"]
        # exit()
        link = parent_obj.links["base_link"]
        lower, upper = link.aabb
        lower = lower.cpu().numpy()
        upper = upper.cpu().numpy()

        # 3. 월드 → 로컬 변환
        lower_local = world_to_local_rot @ (lower - parent_pos)
        upper_local = world_to_local_rot @ (upper - parent_pos)

        # 4. z 고정 (로컬 상단 기준, upper_local[2]도 가능)
        z = upper_local[2]

        # 5. bbox 생성 (로컬 좌표계 기준)
        parent_bbox = np.array([
            [lower_local[0], lower_local[1], z],
            [upper_local[0], lower_local[1], z],
            [upper_local[0], upper_local[1], z],
            [lower_local[0], upper_local[1], z],
        ])
        ...
        x_min = (x_min_p + x_extent_c)/2
        x_max = (x_max_p - x_extent_c)/2
        y_min = (y_min_p + y_extent_c)/2
        y_max = (y_max_p - y_extent_c)/2

        # 8. 축소된 bbox 생성 (z는 그대로 사용)
        z_val = 0
        parent_obj_inside_bbox = np.array([
            [x_min, y_min, z_val],
            [x_max, y_min, z_val],
            [x_max, y_max, z_val],
            [x_min, y_max, z_val],
        ...
        parent_pos = parent_pos.cpu().numpy() if isinstance(parent_pos, th.Tensor) else parent_pos
        parent_quat = parent_quat.cpu().numpy() if isinstance(parent_quat, th.Tensor) else parent_quat
        parent_rot_mat = T.quat2mat(parent_quat)
        ...
        # 3. 4개 꼭짓점 변환 (local → world, z는 유지)
        max_xy = max_bound / 2  # 0.1m
        inside_pos_world = np.zeros((4, 3))  # 결과 배열 (4x3)
    ...
    def snap_to_place(
            ...
            # ✅ child 객체의 AABB 대각선 길이 계산
            child_bbox_dict = compute_obj_bbox_info(child_obj)
            child_bbox = child_bbox_dict["bbox_bottom_in_desired_frame"]

            # x, y, z 크기 계산
            x_size = np.max(child_bbox[:, 0]) - np.min(child_bbox[:, 0])
            y_size = np.max(child_bbox[:, 1]) - np.min(child_bbox[:, 1])
            z_size = np.max(child_bbox[:, 2]) - np.min(child_bbox[:, 2])
            ...
            fixed_joint = create_joint(
                prim_path=f"{parent_obj.prim_path}/fixed_joint",
                joint_type="FixedJoint",
                body1=parent_obj.root_link.prim_path,
                body0=None,  # World와 연결할 때
            )
            ...
            elif (placement == "right" or placement=="left" or placement=="front" or placement=="back"):
            ...
            #  # ✅ 먼저 z값을 0.05m 올리기
            # initial_z_offset = 0.05  # 5cm
            # child_pos = child_pos + th.tensor([0, 0, initial_z_offset], dtype=th.float)
            # child_obj.set_position_orientation(position=child_pos)
            ...
            # parent_obj.root_link.mass = original_mass
            # if child_obj_name=="bottle":
            #     for i in range(10000):
            #         og.sim.step()
            #         og.sim.render()

            prim_path = fixed_joint.GetPath()  # e.g., "/World/scene_0/cabinet_0/fixed_joint"
            og.sim.stage.RemovePrim(prim_path)
    ...
    def place_with_distractor(
            ...
            for i in range(len(distractor_list)):
                ...
                for link_name, link in parent_obj.links.items():
                    # 1. AABB (월드 좌표계)
                    lower, upper = link.aabb
                    world_center = link.aabb_center
                    lower = lower.cpu().numpy() if hasattr(lower, "cpu") else np.array(lower)
                    upper = upper.cpu().numpy() if hasattr(upper, "cpu") else np.array(upper)
                    # 2. 월드 → 로컬 변환
                    lower_local = world_to_local_rot @ (lower - parent_pos)
                    upper_local = world_to_local_rot @ (upper - parent_pos)
                    ...
                    x_size, y_size, z_size = size_local  # unpack
                    if not link_name.startswith("base_link"):
                        all_link_bboxes[link_name] = {
                            "world_center": world_center.cpu().numpy(),
                            "x_size": x_size,
                            "y_size": y_size,
                            "z_size": z_size
                        }

                nearest_link = "base_link"
                nearest_dist = 100
                for link_name, data in all_link_bboxes.items():
                    center = data["world_center"]
                    dist = np.linalg.norm(center - parent_pos)  # 유클리드 거리
                    if dist < nearest_dist:
                        nearest_link = link_name
                        nearest_dist = dist
                
                tol = 1e-4  # 허용 오차 마진
                link_sizes = all_link_bboxes[nearest_link]  
                for distractor_obj_name in distractor_obj_list:
                    parent_obj.keep_still()
                    parent_obj.visual_only = False
                    distractor_obj = scene.object_registry("name", distractor_obj_name)
                    distractor_bbox_dict = compute_obj_bbox_info(distractor_obj)

                    # === bbox 기반 사이즈 계산 ===
                    distractor_bbox_bottom = distractor_bbox_dict['bbox_bottom_in_desired_frame']
                    distractor_bbox_top = distractor_bbox_dict['bbox_top_in_desired_frame']

                    # X 사이즈: 아래 네 점 중 X좌표 최대 - 최소
                    x_size = np.max(distractor_bbox_bottom[:, 0]) - np.min(distractor_bbox_bottom[:, 0])
                    # Y 사이즈: 아래 네 점 중 Y좌표 최대 - 최소
                    y_size = np.max(distractor_bbox_bottom[:, 1]) - np.min(distractor_bbox_bottom[:, 1])
                    # Z 사이즈: 위/아래 Z좌표 차이 (평균 사용 가능)
                    z_size = np.mean(distractor_bbox_top[:, 2] - distractor_bbox_bottom[:, 2])

                    distractor_bbox_sizes = {
                        "x_size": x_size,
                        "y_size": y_size,
                        "z_size": z_size
                    }
                    ...
                    distractor_obj.set_position_orientation(th.tensor(parent_pos, dtype=th.float),
                    th.tensor(parent_quat, dtype=th.float))
                    distractor_obj.keep_still()
                    distractor_obj.visual_only = False
    ...
    def above_collision_check(
        ...
        assert probability_map_sampler is not None, "probability_map_sampler must be provided."

        def check_valid_pose(child_obj, dist_diff_threshold=100.0, x_diff_threshold=100.0, y_diff_threshold=100.0):
            """
        ...
        child_pos[2] = orig_obj_pos[2]
        # Sofa Read
        # child_pos = [ 0.39653632, -0.11724305,  orig_obj_pos[2] ]
        # Sofa Read
        # child_pos = [0.40485913, 0.07703131, orig_obj_pos[2] ]
        # Office File holder
        # child_pos = [-1.8191444,  0.35099566, orig_obj_pos[2] ]
        # Bed Pillow
        # child_pos = [0.10708344, 1.0101843, orig_obj_pos[2] ]
        # Bed Lamp
        # child_pos = [-1.0992154,   1.0752356, orig_obj_pos[2] ]
        # Bed Alarm Clock
        # child_pos = [1.1621728, 1.0800861, orig_obj_pos[2] ]
        # long Tomato can
        # child_pos = [3.8120608, 1.671923, orig_obj_pos[2] ]
        # long bottle on the sofa
        # child_pos = [-0.9566768,  0.6829367, orig_obj_pos[2] ]
        # long bottle on the sofa
        # child_pos = [-0.8158415,   0.54694486, orig_obj_pos[2] ]
        # small bottle on the sofa
        # child_pos = [1.7125536, 0.07582432, orig_obj_pos[2] ]
        # small bottle , bowl
        # child_pos = [2.1710186,  0.47791177, orig_obj_pos[2] ]
        # small bottle, can
        # child_pos = [4.0332117, 0.4651764, orig_obj_pos[2] ]
        # small box
        # child_pos = [2.0963163, 0.4050972, orig_obj_pos[2] ]
        # small box, sofa
        # child_pos = [1.7232245,  0.04218848, orig_obj_pos[2] ]
        # Table bottle
        # child_pos = [1.1969143,  0.25194466, orig_obj_pos[2] ]
        # Table bottle on the talbe
        # child_pos = [ 0.96743715, -0.49550062, orig_obj_pos[2] ]
        # Table box on the table
        # child_pos = [ 0.92253715, -0.48685938, orig_obj_pos[2] ]
        # Table box on the table
        # child_pos = [ 0.935311,  -0.3252526, orig_obj_pos[2] ]
        
        # print(child_obj_name)
        # if child_obj_name == "bottle":
        #     child_pos = [ 0.54862446, 0.6294187, orig_obj_pos[2] ]
        # else : 
        #     child_pos = [ 0.25657034, -0.37444347, orig_obj_pos[2] ]
