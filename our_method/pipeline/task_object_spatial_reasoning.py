...
class TaskObjectSpatialReasoning:
    """
...
##################################################################
        ...
        with open(task_object_extraction_output_path, "r") as f:
            target_object_extraction_info = json.load(f)
        ...
        # print(step_1_output_info)        
        # print(detected_categories_info)        
...
##########################################
        ...
        """)
        return True, task_object_spatial_reasoning_path
