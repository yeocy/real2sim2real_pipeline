...
# TEST_DIR = "/home/kodogyu/projects/Research/SATELLITE/real2sim2real_pipeline/our_method_test/test_office/Bring me the pencil case from the cabinet"
# TEST_DIR = "/home/kodogyu/projects/Research/SATELLITE/real2sim2real_pipeline/our_method_test/test_meeting_room"
# TEST_DIR = "/media/kodogyu/PortableSSD/GAIA/Figure_3_ACDC_output/sofa"
# TEST_DIR = "/media/kodogyu/PortableSSD/GAIA/Figure_3_ACDC_output/toilet"
TEST_DIR = "/media/kodogyu/PortableSSD/GAIA/Figure_3_ACDC_output/office"
...
def test_acdc_step_visualize_scene_imgs(args):
    from our_method.pipeline.acdc import ACDC
    pipeline = ACDC()
    ...
    pipeline.run(
        ...
        scene_info_path=f"{TEST_DIR}/acdc_output/task_scene_generation/scene_info.json",
        # task_object_resizing_path=f"{TEST_DIR}/acdc_output/step_3_output/scene_0/scene_0_info.json",
...
def main(args):
    ...
    # test_acdc_step_visualize_scene_imgs(args)
    test_module(args)
    # og.shutdown()
