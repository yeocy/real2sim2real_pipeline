...
class OpenandGrabSkill(ManipulationSkill):
    ...
    def initialize(self):
        ...
        def pose_updater():
            ...
            self._joint_to_approach_pos_2 = self._joint_rel_mat.T @ OT.quat2mat(parent_link_ori).T @ (
                        grasp_pos_canonical - joint_world_pos + approach_offset/2)
    ...
    def compute_current_subtrajectory(
        ...
        # (6) Retreat from grasp
            ...
            # target_quat = th.tensor([0.7071, 0.0000, 0.0000, 0.7071], dtype=th.float32)
            # target_quat = th.tensor([ 0.9962, -0.0872,  0.0000,  0.0000], dtype=th.float32)
