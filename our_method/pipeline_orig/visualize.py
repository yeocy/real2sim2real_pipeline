...
####################################################
        ...
        for scene_count in range(1, 2):
            ...
            # Create a new scene
            scene = SimulatedSceneVisualize.create_scene(floor=True)
            h, w, _ = rgb.shape
            ...
            scene = SimulatedSceneVisualize.load_cousin_scene(scene_info=scene_info, visual_only=True)
